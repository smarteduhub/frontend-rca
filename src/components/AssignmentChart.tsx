...
export function AssignmentChart() {
   ...
   const monthlyData = useMemo<MonthlyData[]>(() => {
      ...
      const processed = assignments.reduce((acc: MonthlyData[], assignment: Assignment) => {
      ...
      return processed.sort((a, b) => months.indexOf(a.month) - months.indexOf(b.month));
   }, [assignments]);
         ...
         <Card className="border shadow-md">
            ...
            <CardContent>
               <div className="h-64 flex flex-col items-center justify-center text-gray-500">
                  ...
                  <p className="text-sm mt-1">Your assignment progress will appear here</p>
               </div>
            </CardContent>
         </Card>
      );
         ...
         <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
               ...
               <div className="flex items-center bg-green-50 text-green-700 px-2 py-1 rounded">
                  ...
                  <span className="text-sm font-medium">{trend >= 0 ? `+${trend}` : trend} this period</span>
               </div>
            </div>
         ...
         <CardFooter className="pt-0">
            <div className="flex items-center text-sm text-gray-500">
               ...
               {monthlyData.length > 0 
                  ? `Showing data from ${monthlyData[0].month} to ${monthlyData[monthlyData.length - 1].month}`
