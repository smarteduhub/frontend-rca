...
function ActivationForm() {
  ...
  const onSubmit = async (data: ActivationData) => {
    ...
    if (!activationToken) {
      toast.error(
        "Activation link is missing a token. Please use the link from your email."
      );
      setIsSubmitting(false);
      return;
    }
    try {
      await apiClient.activateUser(activationToken);
      await apiClient.updateUser(activationToken, {
        ...
        <div className="mx-auto flex w-full max-w-md flex-col">
          <div className="rounded-[28px] bg-white px-6 py-8 shadow-sm text-center">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Your student account has been successfully activated. You can now
        ...
        <div className="rounded-[28px] bg-white px-6 py-8 shadow-sm">
          ...
          <div className="space-y-1 mb-6">
            ...
            <p className="text-sm text-slate-500">
              Use your school email to set your password. This link should come
          ...
          <div className="mb-6 p-3 rounded-lg bg-amber-50 border border-amber-200">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>
                  You must use your official school email. If activation fails,
                  ask admin to resend your activation link.
                </p>
              </div>
            </div>
          </div>
