        ...
        <div className="mx-auto flex w-full max-w-md flex-col">
          <div className="rounded-[28px] bg-white px-6 py-8 shadow-sm text-center">
            ...
            <p className="text-sm text-slate-500 mb-6">
              We&apos;ve sent a password reset link to your school email. Please
        ...
        <div className="rounded-[28px] bg-white px-6 py-8 shadow-sm">
          ...
          <div className="space-y-1 mb-6">
            ...
            <p className="text-sm text-slate-500">
              Enter your student ID and school email to receive a password reset
              link.
            </p>
          </div>
          ...
          <div className="mb-6 p-3 rounded-lg bg-blue-50 border border-blue-200">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p>
                  The reset link will be sent to your official school email
                  address.
                </p>
              </div>
            </div>
