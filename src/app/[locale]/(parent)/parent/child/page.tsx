...
const MyChildPage = () => {
  ...
  const formatAttendance = (
    ...
    const { percentage, attended, total } = attendance;
    if (typeof percentage === "number") {
      return `${percentage}% Attendance`;
    }
    if (typeof attended === "number" && typeof total === "number") {
      return `${attended}/${total} Attendance`;
    }
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex gap-4">
                        ...
                        <div className="flex items-center gap-1 text-sm">
                          ...
                          <span>
                            {formatAttendance(selectedChildData.attendance)}
                          </span>
                        </div>
                        <div className="flex items-center gap-1 text-sm">
                          <Clock size={16} className="text-main" />
                          <span>
                            {formatUpcomingCount(selectedChildData.upcoming)}
                          </span>
                        </div>
                      </div>
                    </div>
